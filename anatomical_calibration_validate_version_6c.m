...
function [T_val, R_val, unit_vectors, success_bool, reconstructed_vectors] = pose_estimate_technical_frame_rigid_body(current_time_idx, marker_input, local_vectors_input)
    ...
    current_scaled_vectors_unit = struct;
    for c=1:3
        ...
        if length(marker_info(sorted_vertex(c)).x) > 1
            ...
            current_scaled_vectors_unit(c).x = NewX_val;
            ...
            current_scaled_vectors_unit(c).y = NewY_val;
            ...
            current_scaled_vectors_unit(c).z = NewZ_val;
            ...
            current_scaled_vectors_unit(c).x = nan;
            current_scaled_vectors_unit(c).y = nan;
            current_scaled_vectors_unit(c).z = nan;
    ...
    Global_sideOne = sqrt((current_global_vectors_unit(1).x - current_global_vectors_unit(2).x)^2 + (current_global_vectors_unit(1).y - current_global_vectors_unit(2).y)^2 + (current_global_vectors_unit(1).z - current_global_vectors_unit(2).z)^2);
    Section_sideOne = sqrt((current_scaled_vectors_unit(1).x - current_scaled_vectors_unit(2).x)^2 + (current_scaled_vectors_unit(1).y - current_scaled_vectors_unit(2).y)^2 + (current_scaled_vectors_unit(1).z - current_scaled_vectors_unit(2).z)^2);
    Local_sideOne = sqrt((local_vectors(1).x - local_vectors(2).x)^2 + (local_vectors(1).y - local_vectors(2).y)^2 + (local_vectors(1).z - local_vectors(2).z)^2);
    disp([Global_sideOne, Section_sideOne, Local_sideOne]);
    
    Global_sideTwo = sqrt((current_global_vectors_unit(2).x - current_global_vectors_unit(3).x)^2 + (current_global_vectors_unit(2).y - current_global_vectors_unit(3).y)^2 + (current_global_vectors_unit(2).z - current_global_vectors_unit(3).z)^2);
    Section_sideTwo = sqrt((current_scaled_vectors_unit(2).x - current_scaled_vectors_unit(3).x)^2 + (current_scaled_vectors_unit(2).y - current_scaled_vectors_unit(3).y)^2 + (current_scaled_vectors_unit(2).z - current_scaled_vectors_unit(3).z)^2);
    Local_sideTwo = sqrt((local_vectors(2).x - local_vectors(3).x)^2 + (local_vectors(2).y - local_vectors(3).y)^2 + (local_vectors(2).z - local_vectors(3).z)^2);
    disp([Global_sideTwo, Section_sideTwo, Local_sideTwo]);
    
    Global_sideThree = sqrt((current_global_vectors_unit(1).x - current_global_vectors_unit(3).x)^2 + (current_global_vectors_unit(1).y - current_global_vectors_unit(3).y)^2 + (current_global_vectors_unit(1).z - current_global_vectors_unit(3).z)^2);
    Section_sideThree = sqrt((current_scaled_vectors_unit(1).x - current_scaled_vectors_unit(3).x)^2 + (current_scaled_vectors_unit(1).y - current_scaled_vectors_unit(3).y)^2 + (current_scaled_vectors_unit(1).z - current_scaled_vectors_unit(3).z)^2);
    Local_sideThree = sqrt((local_vectors(1).x - local_vectors(3).x)^2 + (local_vectors(1).y - local_vectors(3).y)^2 + (local_vectors(1).z - local_vectors(3).z)^2);
    disp([Global_sideThree, Section_sideThree, Local_sideThree]);
    disp("--------------------")
